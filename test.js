...
// const initialS = { //начальное значение state
//     catalog:  [],
//     // catalog: {data: [], isLoading: false}, user: {data:[], isLoading: false}
//     cart: [],
//     isLoading: false
// }
// export const catalogReducer1 = (state = initialState1, action) => { //reducer - распределитель данных. Есть два пара-ра 1. начальное значение store 2. событие
//     switch (action.type) {
...
//                 return {...state,
//                     cart: state.cart.map(item => item.id === findProduct.id ?  {  //map - переб-ет [] c товар-и, которые уже есть в корзине
